...
public class Main {   
	...
	private static Scanner lerTexto;
	private static Scanner lerValor;
	private static Scanner lerInteiro;
	public static void main(String[] args) {
        ler = new Scanner(System.in);
        lerTexto = new Scanner(System.in);
        lerValor = new Scanner(System.in);
        lerInteiro = new Scanner(System.in);
        int op = 0;
